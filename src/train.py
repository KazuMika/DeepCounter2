...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'yolov5/yolov5n.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov5n.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'yolov5/data/dtc.yaml', help='dataset.yaml path')
